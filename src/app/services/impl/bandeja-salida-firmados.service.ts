...
export class BandejaSalidaFirmadosService implements IBandejaSalidaFirmadosService {
  ...
  constructor(private http: HttpClient,
    ...
    this.apiEndpointPDF = environment.serviceEndpoint + '/bandejas/firmados.pdf';
    this.apiEndpointExcel = environment.serviceEndpoint + '/bandejas/firmados.xls';
    this.apiEndpoint = environment.serviceEndpoint + '/bandejas/firmados';
    this.apiEndpointDocumento = environment.serviceEndpoint + '/documentos-salientes/';
  }
  ...
  generarCargo(codDocumento: string, codMovimiento: string) {
    const url = `${this.apiEndpointDocumento}/${codDocumento}/${codMovimiento}/cargo`;
